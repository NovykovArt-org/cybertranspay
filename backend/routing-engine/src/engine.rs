...
const CATALOG: &[RouteCandidate] = &[
    RouteCandidate {
        ...
        rails: &["fiat", "bank"],
        from_assets: &["EUR", "USD", "GBP", "PLN"],
        to_assets: &["EUR", "USD", "GBP", "PLN", "JPY", "AED"],
        fee_percent: 0.35,
        eta_minutes: 1440,
        compliance_score: 95,
    },
    RouteCandidate {
        ...
        to_assets: &["USDT", "EUR", "USD", "TRY", "AED"],
        fee_percent: 0.15,
        eta_minutes: 5,
        compliance_score: 78,
    },
    ...
    RouteCandidate {
        ...
        rails: &["crypto", "cex"],
        from_assets: &["USDT", "USDC", "BTC", "ETH"],
        to_assets: &["EUR", "USD", "USDT", "JPY", "RUB"],
        fee_percent: 0.28,
        eta_minutes: 8,
        compliance_score: 80,
    },
